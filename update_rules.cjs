  ...
  <div class='lofi-modal'>
    ...
    {#if showInfoModal}
      ...
      <div class='info-text'>
        ...
        <p style="background:rgba(255,255,255,0.2); padding:8px; border-radius:8px; margin-top:10px;">
          ✨ <b>BONUS:</b> Find <b>3 Wild Lamps</b> to trigger <b>10 FREE SPINS</b>! Every 3 extra Wilds during the bonus adds <b>+5 more spins</b>!
        </p>
      </div>
...
console.log('✅ RULES UPDATED: Triple-Wild Bonus successfully added to Info Screen.');
