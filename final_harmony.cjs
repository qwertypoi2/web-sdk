...
<div class='game-container'>
  ...
  <div class='panel'>
    ...
    <div class='controls'>
      ...
      <button class='side-btn' on:click={() => mute = !mute}>{mute ? '🔇' : '🔊'}</button>
...
<style>
  ...
  .banner { position:absolute; top:40%; left:50%; transform:translate(-50%, -50%); padding:15px 20px; border-radius:24px; z-index:5000; text-align:center; color:white; background:#e07a5f; border:4px solid white; box-shadow:0 15px 45px rgba(0,0,0,0.4); min-width:240px; }
  ...
  .icon-frame { width:28px; height:28px; background:rgba(61, 64, 91, 0.8); border:1.5px solid white; border-radius:50%; display:flex; align-items:center; justify-content:center; padding:3px; }
...
console.log('✅ SFX FIXED, MUTE ADDED, LOFI AESTHETIC RESTORED');
